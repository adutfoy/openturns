"""
Estimate a confidence interval of a particular quantile
=======================================================
"""

# %%
# In this example, we detail two ways to estimate a confidence interval of the quantile of order :math:`\alpha` of a scalar random
# variable :math:`X`. Both ways use the order statistics to estimate:
#
# - an asympotic confidence interval of level :math:`\beta`,
# - an exact upper bounded confidence interval of level :math:`\beta`.
#
# In this example, we consider the quantile of order :math:`\alpha = 95\%`,
...
# %%
# We define the order :math:`\alpha` of the quantile and the confidence level :math:`\beta`.
...
# %%
# We get the empirical estimator of the quantile of order :math:`\alpha` which is the
# :math:`\lfloor N\alpha \rfloor` -th order statistics evaluated on
# the sample.
